...
JAVA_JRE=jre-7u80-linux-x64			# Times font missing

JAVA_EXEC=${JAVA_JRE}/bin/java
${JAVA_EXEC} -Xms256m -Xmx1024m -Dsun.java2d.noddraw=true -classpath ${LOCALCLASSPATH} com.intooitus.infusion.util.Java2MSE $1 $2 $3